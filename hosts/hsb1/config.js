window.HOSTDASH_CONFIG = {
  ...
  services: [
    { wing: "home", name: "Home Assistant", purpose: "Smart-home hub & automations", icon: "logo-ha", url: "http://hsb1.lan:8123/", sameHost: true, port: ":8123" },
    { wing: "home", name: "Node-RED", purpose: "Visual flow automation", icon: "logo-nodered", url: "http://hsb1.lan:1880/", sameHost: true, port: ":1880" },
    { wing: "home", name: "Zigbee2MQTT", purpose: "Zigbee to MQTT bridge", icon: "logo-z2m", url: "http://hsb1.lan:8888/", sameHost: true, port: ":8888" },
    { wing: "home", name: "opusweb", purpose: "OPUS greenNet EnOcean control", icon: "sliders", url: "http://hsb1.lan:3102/", sameHost: true, port: ":3102" },
    { wing: "home", name: "Matter Server", purpose: "Matter/Thread controller for HA", icon: "hexagon", passive: true, foot: ":5580 api · no UI" },

    { wing: "media", name: "Plex", purpose: "Media library & streaming", icon: "logo-plex", url: "http://hsb1.lan:32400/web", sameHost: true, port: ":32400", path: "/web" },
    { wing: "media", name: "pixdcon", purpose: "Pixoo pixel-display controller", icon: "logo-pixdcon", url: "http://hsb1.lan:8080/", sameHost: true, port: ":8080" },
    { wing: "media", name: "funkeykid", purpose: "Kids audio/voice toy console", icon: "toy-brick", url: "http://hsb1.lan:8081/", sameHost: true, port: ":8081" },

    { wing: "signals", name: "Apprise", purpose: "Unified notification gateway", icon: "logo-apprise", url: "http://hsb1.lan:8001/", sameHost: true, port: ":8001" },
    ...
    { wing: "safety", name: "Scrypted", purpose: "Camera/NVR hub to HomeKit/HA", icon: "logo-scrypted", url: "https://hsb1.lan:10443/", sameHost: true, scheme: "https:", port: ":10443", certIssue: true, note: "service answers with a self-signed localhost certificate" },
    { wing: "safety", name: "fritz-tripwire", purpose: "Snapshots mesh on device drop", icon: "shield-alert", url: "http://hsb1.lan:9000/", sameHost: true, port: ":9000", note: "plain-text status endpoint" },
