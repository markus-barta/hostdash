window.HOSTDASH_CONFIG = {
  ...
  services: [
    { wing: "network", name: "AdGuard Home", purpose: "LAN DNS, DHCP, filtering, and rewrites", icon: "logo-adguard", url: "http://hsb0.lan:3000/", port: ":3000" },
    { wing: "network", name: "NCPS", purpose: "Nix binary cache proxy for the LAN fleet", icon: "hard-drive-download", url: "http://hsb0.lan:8501/", port: ":8501" },

    { wing: "agents", name: "OpenClaw Gateway", purpose: "Merlin and Nimue multi-agent control UI", icon: "logo-openclaw", url: "https://hsb0.lan:18789/", port: ":18789", certIssue: true, note: "gateway is HTTPS-only and uses a self-signed certificate" },
    ...
    { wing: "telemetry", name: "Speedtest Tracker", purpose: "Starlink WAN speed history and scheduled checks", icon: "logo-speedtest", url: "http://hsb0.lan:8765/", port: ":8765" },
